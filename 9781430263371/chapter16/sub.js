...
Sub.prototype = {
  ...
  draw: function (context) {
    ...
    context.fillStyle = "#ffffff";
    context.fillRect(
      this.x + 0.5 * this.tankWidth,
      this.y + 0.5 * this.tankHeight,
      this.tankWidth,
      this.tankHeight
    );
    // draw water in tank
    ...
    context.fillRect(
      this.x + 0.5 * this.tankWidth,
      this.y + 1.5 * this.tankHeight - this.waterHeight,
      this.tankWidth,
      this.waterHeight
    );
  },
